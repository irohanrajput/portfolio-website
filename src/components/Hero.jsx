      ...
      <div className="container mx-auto px-6 z-10">
        ...
        >
          ...
          <div className="flex justify-center space-x-6 mb-8">
            ...
            <a href="https://github.com/irohanrajput" target="_blank" rel="noopener noreferrer" className="text-purple-900 hover:text-purple-700">
              <FaGithub size={28} />
            </a>
            <a href="https://linkedin.com/in/irohanrajput" target="_blank" rel="noopener noreferrer" className="text-purple-900 hover:text-purple-700">
              <FaLinkedin size={28} />
            </a>
            <a href="https://x.com/irohanrajput" target="_blank" rel="noopener noreferrer" className="text-purple-900 hover:text-purple-700">
              <FaTwitter size={28} />
            </a>
          </div>
